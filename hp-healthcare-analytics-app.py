...
with tab2:
    ...
    compute_fc = st.button("Compute Forecast")

    if compute_fc:
        # All your existing Tab 2 code goes here
        # df_for_fc, ser, train/test split, model fitting, metrics, plots, etc.
        ...
        st.info("Press 'Compute Forecast' to run the models and generate forecasts.")
